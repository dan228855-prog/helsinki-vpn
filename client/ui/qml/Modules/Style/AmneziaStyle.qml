...
QtObject {
    property QtObject color: QtObject {
        ...
        readonly property color softViolet: '#C084FC'
        ...
        readonly property color softGoldenApricot: Qt.rgba(168/255, 85/255, 247/255, 0.3)
        ...
        readonly property string goldenApricotString: '#A855F7'
    }
}
